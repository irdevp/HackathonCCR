...
class _SearchBusinessState extends State<SearchBusiness> {
  TextEditingController _fieldSearchProfessional = TextEditingController();
  List queryList = [];
  int queryCount = 0;
  Response response;
  Dio dio = new Dio();
        ...
        children: [
          Expanded(
            ...
            child: Container(
                ...
                child: TextFormField(
                  controller: _fieldSearchProfessional,
                  ...
                  decoration: InputDecoration(
                    labelText: "Busque por nome curso ou área",
                    fillColor: _fieldSearchProfessional.text.isNotEmpty
                        ? Colors.white
                        : Color(0xFF35363F),
          ...
          Expanded(
            flex: 5,
            child: _fieldSearchProfessional.text.isEmpty
                ? buildSnips()
                : !loading
                    ? ListView.builder(
    ...
    return Expanded(
      child: Container(
        child: InkWell(
          onTap: () {
            setState(() {
              _fieldSearchProfessional.text = text;
              _onSearchChanged(_fieldSearchProfessional.text);
            });
          },
          child: Container(
